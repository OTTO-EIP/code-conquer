...
void loadAllTexture() {
    icon = LoadTexture("../../assets/map/Interface/menu.png"); // Charger l'icône depuis un fichier
    iconLoaded = true;
    buildMenu = LoadTexture("../../assets/map/Interface/menu_open.png"); // Charger l'icône depuis un fichier
